    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <a class="btn btn-dark" href="/questionnaires/{{ $questionnaire->id }}/questions/create_normal">Add New Question</a>
                    <a class="btn btn-dark" href="/questionnaires/{{ $questionnaire->id }}/questions/create">Add Multiple Choice Question</a>
            ...
            @foreach($questionnaire->questions as $question)
                <div class="card mt-4">
                    ...
                    @if (!isset($question->answers[0]))
                        <ul class="list-group">
                                @foreach($question->normal_answers as $answer)
